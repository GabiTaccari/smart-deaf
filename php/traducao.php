<?php
    ...
    echo"<html lang='pt-br'>";
        echo"<head>";
            echo"<title>Smart Deaf - Tradutor</title>";
       ...
       echo" </head>";
                                ...
                                echo"<div class='col-3 col-lg-9 flex justify-content-end align-content-center'>";
                                    echo"<nav class='site-navigation flex justify-content-end align-items-center'>";
                                        echo"<ul class='flex flex-column flex-lg-row justify-content-lg-end align-content-center'>";
                                            ...
                                            echo"<li  class='current-menu-item'><a href='../tradutor.html'>Tradutor</a></li>";
        ...
        echo"<div class='container'>";
            ...
            echo"</div><!-- .row -->";
                ...
                //recebe a frase traduzida
                include_once ('conecta_banco');
        @$traducao = $_POST[traduzir];

        //divide a frase em palavras
        $array=explode(" ",$traducao);
        $query = mysqli_query($conecta_banco, "select link_traducao from traducao_libras where nome_traducao = '{$array}'");

         if(!$query)
         {
             die('Query Inválida' . mysqli_error($conexao)); // mostra o erro
         }
        //pesquisa palavra por palavra

         while ($dados = mysqli_fetch_array($query))
        {
            echo "<iframe width='810' height='446' src='$query' frameborder='0' allow='autoplay; encrypted-media' allowfullscreen></iframe>";
        }
